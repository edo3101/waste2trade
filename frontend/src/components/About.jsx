...
<div class="flex h-screen items-center justify-center bg-gray-50">
  <div class="w-full md:w-1/2 rounded-lg bg-white px-8 py-4 shadow-md m-4">
    <div class="px-1 py-4">
      <h3 class="font-bold text-2xl font-sans text-custom-tertiary">Tim Waste2Trade</h3>
    </div>
      <ul class="grid grid-cols-4 gap-2 px-1">
        <li class="flex items-center flex-col">
          <img src="" alt="" class="rounded-full w-16 h-16 object-cover"/>
          <h5 class="font-semibold text-custom-secondary">Anjas</h5>
        </li>
          <li class="flex items-center flex-col">
          <img src="" alt="" class="rounded-full w-16 h-16 object-cover"/>
          <h5 class="font-semibold text-custom-secondary">Edo</h5>
        </li>
          <li class="flex items-center flex-col">
          <img src="" alt="" class="rounded-full w-16 h-16 object-cover"/>
          <h5 class="font-semibold text-custom-secondary">Fandi</h5>
        </li>
         <li>
          <li class="flex items-center flex-col">
          <img src="" alt="" class="rounded-full w-16 h-16 object-cover"/>
          <h5 class="font-semibold text-custom-secondary">Garuda</h5>
          </li>
        </li>
         <li class="flex items-center flex-col">
          <img src="" alt="" class="rounded-full w-16 h-16 object-cover"/>
          <h5 class="font-semibol text-custom-secondary">Annisa</h5>
          </li>
      </ul>
  </div>
</div>
